<template>
  <ul class="list">
      <router-link to="/mado"><li class="works" ref="a" :class="fadeList[0]?'fade':'fout'">
      ...
      <router-link to="/figma"><li class="works" ref="b" :class="fadeList[1]?'fade':'fout'">
      ...
      <router-link to="/figma"><li class="works" ref="c" :class="fadeList[2]?'fade':'fout'">
